    ...
    <footer className="bg-gray-50 border-t border-gray-200 py-8 mt-16">
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <img src={logo} alt="PageTurner Logo" className="h-20 w-40 object-contain" />
        ...
        <nav className="flex gap-6">
          ...
          <a href="/course" className="text-gray-600 hover:text-blue-600 transition-colors">Courses</a>
        ...
        <div className="flex gap-4">
          ...
          <a href="#" aria-label="Facebook" className="text-gray-500 hover:text-blue-700 transition-colors">
      ...
      <div className="text-center text-gray-400 text-sm mt-6">
        © 2025 PageTurner. All rights reserved.
      </div>
    </footer>
  );
}
